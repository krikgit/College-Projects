...
<body>
   ...
   <form style="max-width:500px;margin:auto" action="admin_serch_result.jsp" method="post">
  <h3 align="center">SEARCH STUDENT PROFILE</h3>
  <div class="input-container">
      <input class="input-field" type="text" placeholder="ROLL NUMBER" name="rollno" required="required">
  </div>
