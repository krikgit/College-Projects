<%-- 
    Document   : Details
    Created on : May 17, 2019, 9:28:17 PM
    Author     : chaya
--%>
...
<head>
    ...
    <!-- Title -->
    <title>SPR|Delete Profile</title>
...
<center>
   <form style="max-width:500px;margin:auto"  method="post" align="center" action="delete">
  ...
  <br>
   ...
   <table align="center" border="2" bordercolor="#f0f0f0">
      ...
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br/>
<input type="submit" value="Cofirm Delete"/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
