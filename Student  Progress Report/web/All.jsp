<%-- 
    Document   : All
    Created on : May 17, 2019, 9:36:13 PM
    Author     : chaya
--%>
...
<head>
    ...
    <!-- Title -->
    <title>SPR|All Student Profiles</title>
...
<center>
   ...
   <form style="max-width:500px;margin:auto"  method="post" align="center">
       <table align="center" border="2" bordercolor="#f0f0f0">
            <tr>
            <th aliign="center"> Roll </th>
            <th aliign="center"> Name </th>
            <th aliign="center"> Contact No. </th>
            </tr>
            <%
            ...
            %>
            <tr>
            <td aliign="center"><%= r.getLong(1)%></td>
            <td aliign="center"><%= r.getString(3)%></td>
            <td aliign="center"><%= r.getLong(8)%></td>
            </tr>
