<%-- 
    Document   : alogin
    Created on : May 7, 2019, 8:10:24 PM
    Author     : chaya
--%>
    ...
    <!-- ##### Header Area End ##### -->
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-50 p-r-50 p-t-77 p-b-30">
					...
					<div class="wrap-input100 validate-input m-b-16" data-validate = "Enter Your Credential">
					...
					<div class="container-login100-form-btn p-t-25">
						<button class="login100-form-btn" title="If you dont know login credential please contact System Admin.">
							Login
						</button>
					</div>
